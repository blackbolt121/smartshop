        ...
        <div className="w-full max-w-2xl mx-auto" ref={searchRef}>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-[100px] sm:w-[300px] md:w-[400px] lg:w-[600px] pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
                {isLoading && (
